...
exports.sendPasswordResetEmail = exports.sendClientConfirmation = exports.sendConsultationAlert = exports.emailService = exports.EmailService = void 0;
...
const getEmailTemplate = (title, bodyContent, isRTL = true) => {
...
class EmailService {
    async sendConsultationAlert(consultation, files) {
    ...
    async sendClientConfirmation(consultation) {
    ...
    async sendConsultationReminder(email, name, dateStr, refId) {
...
const sendConsultationAlert = (c, f) => exports.emailService.sendConsultationAlert(c, f);
exports.sendConsultationAlert = sendConsultationAlert;
const sendClientConfirmation = (c) => exports.emailService.sendClientConfirmation(c);
exports.sendClientConfirmation = sendClientConfirmation;
const sendPasswordResetEmail = (e, u) => exports.emailService.sendPasswordResetEmail(e, u);
